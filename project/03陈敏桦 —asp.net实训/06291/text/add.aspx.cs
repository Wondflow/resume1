...
public partial class web_add : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string str1 = "insert into text(type,title,content,sdate) values('"
                             + type + "','"
                             + title + "','"
                             + content + "','"
                             + sdate + "')";
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        v4 = ((TextBox)(GridView1.Rows[e.RowIndex].Cells[4].Controls[0])).Text.ToString();
        ...
        string str1 = "update text set " +
            "type='" + v1 + "'," +
            "title='" + v2 + "'," +
            "content='" + v3 + "'," +
            "sdate='" + v4 + "'  where ID=" + id;
 ...
 protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        string strcon = "Database='hospit';Data Source=localhost;user ID='root';PassWord='123456';";
        MySqlConnection conn = new MySqlConnection(strcon);
        conn.Open();
        ...
        string str1 = " delete from text where id=" + id;
        MySqlCommand cmd = new MySqlCommand(str1, conn);
        int res = cmd.ExecuteNonQuery();
        if (res > 0)
        {
